...
import com.github.hualuomoli.config.QueueActiveMqListenerConfig;
import com.github.hualuomoli.config.TopicActiveMqListenerConfig;
import com.github.hualuomoli.util.ProjectConfig;

@WebAppConfiguration
@ContextConfiguration(classes = { BaseComponentConfig.class, ConnectionConfig.class, QueueActiveMqListenerConfig.class, TopicActiveMqListenerConfig.class })
